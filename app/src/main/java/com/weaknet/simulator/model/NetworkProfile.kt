...
data class NetworkProfile(
    ...
    companion object {
        ...
        val MX_CITY_4G = NetworkProfile("墨城4G", 200, 100, 0.01f, 0, 0, "墨西哥")
        val MX_CROSS_BORDER = NetworkProfile("跨境US", 400, 150, 0.02f, 0, 0, "墨西哥")
        val MX_WEAK = NetworkProfile("墨西哥弱信号", 800, 400, 0.05f, 2048, 4096, "墨西哥")
        val MX_RAINY = NetworkProfile("墨西哥雨季", 1200, 1000, 0.08f, 1024, 2048, "墨西哥")
